...
const routes = [
    { path: 'content', loadChildren: () => __webpack_require__.e(/*! import() | feature-feature-module */ "feature-feature-module").then(__webpack_require__.bind(null, /*! ./feature/feature.module */ "./src/app/feature/feature.module.ts")).then(m => m.FeatureModule) },
...
class AppComponent {
    constructor(router) {
        this.router = router;
        this.title = 'angular-lazy-load-injectable';
    }
    ngOnInit() {
...
class AppModule {
    constructor(injector) {
        ...
        const el = Object(_angular_elements__WEBPACK_IMPORTED_MODULE_2__["createCustomElement"])(_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], { injector: this.injector });
...
module.exports = __webpack_require__(/*! /home/richard/workspace/github/angular-lazy-load-injectable/src/main.ts */"./src/main.ts");
